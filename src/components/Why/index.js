      ...
      >
        <Grid item md={6} className="right-content">
          ...
          <ul>
            ...
            <li>
              Porque podes compartir tus conocimientos con nosotros y nuestra
              comunidad.
            </li>
            <li>
              ¡Porque podes jugar con nosotros todos los meses y sorprenderte!
            </li>
          </ul>

          <h3>
            Sentimos que sabemos de belleza, queremos crear una experiencia de
            belleza única.{" "}
            <strong>
              Queremos ayudarte a ser la mejor versión de vos misma
            </strong>
            .
          </h3>
